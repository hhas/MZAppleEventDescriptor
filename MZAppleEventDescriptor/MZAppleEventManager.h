...
@class MZAppleEventDescriptor;

typedef const struct __MZAppleEventManagerSuspension* MZAppleEventManagerSuspensionID;

extern const double MZAppleEventTimeOutDefault;
extern const double MZAppleEventTimeOutNone;

//extern NSNotificationName MZAppleEventManagerWillProcessFirstEventNotification;

@interface MZAppleEventManager : NSObject {
@private
    //BOOL _isPreparedForDispatch;
    //char _padding[3];
    
    NSMethodSignature *handleEventSignature;
    AEEventHandlerUPP genericEventHandlerUPP;
}
...
@property (nullable, readonly, retain) MZAppleEventDescriptor *currentAppleEvent;
...
@property (nullable, readonly, retain) MZAppleEventDescriptor *currentReplyAppleEvent;
